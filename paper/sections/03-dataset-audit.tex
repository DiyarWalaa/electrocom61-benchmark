...
\citep{gupta2019lvis}; the fifteen classes here are among the most heavily
annotated in the dataset. An imbalanced dataset produces a smooth decline in
test representation as class frequency falls, and cannot
