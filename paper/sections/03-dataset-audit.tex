...
% NOTE, for resolution rather than for the prose: the metadata CSV records FOUR
% distinct DEVICE_NAME values across the 2121 images -- ONEPLUS_NORD (391),
% REDMI (1180), X (311) and iPhone (189), plus 50 images with no CSV row
% (runs/20260801_device_split/). The paper states three phones. The two counts
% are both stated as facts above only in the sense that the prose quotes the
% paper's rationale and not its device count; if the fourth name denotes a
% distinct handset the sentence above should say four, and if it is an alias or
% a placeholder that should be recorded. Needs the PDF to settle.
