...
those classes are. Rarity would leave the least frequent classes unevaluable;
what the data shows is close to the reverse, with the ten most heavily annotated
classes among the least evaluable in the dataset.
...
dataset is how often the defect it describes occurs elsewhere; that would take
the same audit, which costs minutes, run against benchmarks whose collection was
organised in sessions.
