...
Run directory: `20260804_burst_aware_split_02`  |  tau=30s  |  scene eps=0.05  |  seed=20260804
...
|---|---|---|---|---|---|
| test | 20 | 6 | 6 | 10 | **failed** |
| valid | 22 | 31 | 31 | 86 | exact subset found |

**test**: the safe groups hold only 10 images between them, fewer than the 20 required.
