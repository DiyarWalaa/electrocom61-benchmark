...
Run directory: `20260804_burst_feasibility`
...
| regime | setting | single group (unavoidable) | several groups but < 2 qualifying | has alternatives |
|---|---|---|---|---|
| timestamp | tau=3s | 2 | 12 | 1 |
| timestamp | tau=5s | 2 | 5 | 8 |
| timestamp | tau=10s | 2 | 1 | 12 |
| timestamp | tau=30s | 2 | 0 | 13 |
| timestamp | tau=60s | 2 | 0 | 13 |
| scene-component | eps=0.01 | 0 | 4 | 0 |
| scene-component | eps=0.02 | 0 | 4 | 0 |
| scene-component | eps=0.05 | 0 | 2 | 2 |
