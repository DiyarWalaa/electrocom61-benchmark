...
Run directory: `20260809_make_figures_12`
...
A larger tau is not uniformly worse. tau=30 is, tau=45 is clean on contamination but fail on sizes, while tau=35, tau=60 each carry one aligned pair despite sitting between them.
