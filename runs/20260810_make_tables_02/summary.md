...
Run directory: `20260810_make_tables_02`
...
- **T3 is provisional.** 99 of 99 settings in `data/config_provenance.csv` still have no `source`. Until they are filled the table reports settings without saying who chose them.
