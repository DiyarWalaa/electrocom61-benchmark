...
Run directory: `20260812_verify_master_results`

**15 passed, 2 failed** of 17 known values.
...
| **FAIL** | RT-DETR-l published test mAP@50 | `0.9171` | `0.0057 / 0.9171` | DISAGREES ACROSS 2 ROWS |
| PASS | YOLOv12s published test mAP@50-95 | `0.5842` | `0.5842` |  |
| PASS | YOLO11s params_fused | `9,436,407` | `9,436,407` |  |
| **FAIL** | RT-DETR-l gflops_fused | `105.6` | `105.6 / None` | DISAGREES ACROSS 3 ROWS |
